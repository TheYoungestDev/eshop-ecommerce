     ...
     <div class="offcanvas-body">
         <form action="<?= base_url('home/login') ?>" class='form-submit-event' id="login_form" method="post">
             ...
             <div class="d-flex justify-content-between">
                 ...
                 <a href="<?= base_url('register') ?>" id="forgot_password_link">
