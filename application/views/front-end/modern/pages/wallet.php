                ...
                <div class="mt-3">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="wallet-transaction" data-bs-toggle="tab" data-bs-target="#wallet-transaction-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true"><?= label('wallet_transaction', 'Wallet transaction') ?></button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="withdrawal-requests" data-bs-toggle="tab" data-bs-target="#Withdrawal-pane" type="button" role="tab" aria-controls="profile-tab-pane" aria-selected="false"><?= label('withdrawal_requests', 'Withdrawal requests') ?></button>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="wallet-transaction-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        ...
                        <div class="tab-pane fade" id="Withdrawal-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
