            ...
            <div class="row register-login-section">
                ...
                <div id="register_div" class="col-md-6 px-5 registration-section">
                    ...
                    <form id='send-otp-form' class='send-otp-form cmxform' action='#'>
                        <div class="mb-3 sign-up-verify-number">
                            ...
                            <input type="text" class='form-input form-control phone-number-input' pattern="\d*" maxlength="16" placeholder="Enter Mobile Number" id="phone-number" required>
                        </div>
                    ...
                    <form id='verify-otp-form' class='verify-otp-form' action='<?= base_url('auth/register-user') ?>' method="POST" <?php echo $verifyOtpForm; ?>>
                        ...
                        <div class="mb-3 sign-up-verify-number">
                            ...
                            <input type="text" class='form-input form-control' placeholder="OTP" id="otp" name="otp" autocomplete="off" required>
                        </div>
                        <div class="mb-3 sign-up-verify-number">
                            <label for="exampleFormUsername" class="form-label">
                    ...
                    <form action="<?= base_url('home/login') ?>" class='form-submit-event' id="login_form" method="post">
                        ...
                        <div class="d-flex justify-content-between forget-password">
                            <a id="forgot_password_link">
                                <p class=""><?= label('forgot_password', 'Forget Password') ?>?</p>
                            </a>
                        </div>
                        <div class="separator">
                            <span></span>
                ...
                <div class="col-md-6 px-5 text-center Register-text">
                    <div class="login-text">
                        ...
                        <p class="mb-3">To access your account and enjoy a seamless shopping experience, simply enter your registered email address and password in the designated fields. Once logged in, you'll have access to your personalized dashboard, order history, saved payment methods, and more.
                        </p>
