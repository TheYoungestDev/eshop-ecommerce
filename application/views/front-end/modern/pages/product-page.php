    ...
    <section class="container py-4">
        <div class="Product-Detail-card row">
            ...
            <div class="d-none d-lg-block product-img-section-md col-lg-6 row g-0 align-content-start">
                <div class="row align-items-center d-flex flex-row-reverse my-2">
                    <div class="col-md-10">
                        <div class="swiper mySwiper-preview">
                            <div class="swiper-wrapper">
                                ...
                                ?>
                                                <div class="swiper-slide">
                                                    ...
                                                    <img src="<?= $image ?>" class="zoom_03" data-zoom-image="<?= $image ?>">
                                                </div>
                                <?php }
                                        }
                                    }
                    ...
                    <div class="image-Thumbnail-container col-md-2 p-1">
                        ...
                        <div thumbsSlider="" class="swiper mySwiper-productview swiper-arrow">
                            <div class="swiper-wrapper swiper-wrapper-productview">
                                <?php
                                $variant_images_md = array_column($product['product'][0]['variants'], 'images_md');
                                if (!empty($variant_images_md)) {
                                    foreach ($variant_images_md as $variant_images) {
                                ...
                                ?>
                                                <div class="swiper-slide">
                                                    <a class="w-100 h-100" href="<?= $product['product'][0]['image'] ?>">
                                                        <img class="xzoom-gallery swiper-slide-productview" width="80" src="<?= $product['product'][0]['image'] ?>" xpreview="<?= $product['product'][0]['image'] ?>">
                                                    </a>
                                                </div>
                                <?php }
                                        }
                                ...
                                <div class="swiper-slide">
                                    <a class="w-100 h-100" href="<?= $product['product'][0]['image'] ?>">
                                        <img class="xzoom-gallery swiper-slide-productview" width="80" src="<?= $product['product'][0]['image'] ?>">
                                    </a>
                                </div>
                                <?php
                                if (!empty($product['product'][0]['other_images']) && isset($product['product'][0]['other_images'])) {
                                ...
                                ?>
                                        <div class="swiper-slide">
                                            <a class="w-100 h-100" href="<?= $other_image ?>">
                                                <img class="xzoom-gallery swiper-slide-productview" width="80" src="<?= $other_image ?>">
                                            </a>
                                        </div>
                                <?php }
                                } ?>
                                ...
                                ?>
                                    <div class="swiper-slide">
                                        <a class="w-100 h-100" href="<?= base_url('assets/admin/images/video-file.png') ?>">
                                            <img class="xzoom-gallery swiper-slide-productview" width="80" src="<?= base_url('assets/admin/images/video-file.png') ?>">
                                        </a>
                                    </div>
                                <?php } ?>
                            </div>
        ...
        <div class="col-lg-6">
            <div class="p-3 default-cursor">
                <h4 class="product-title"><?= ucfirst($product['product'][0]['name']) ?>
                </h4>
                ...
                if ($product['product'][0]['type'] == "simple_product") { ?>
                    <h1 class="product-price-title">
                        <?php if ($product['product'][0]['is_on_sale'] == 1) { ?>
                            <?php $price = get_price_range_of_product($product['product'][0]['id']);
                            echo $settings['currency'] . '' . $product['product'][0]['variants'][0]['sale_final_price'];
                            ?>
                        <?php } else { ?>
                            <?php $price = get_price_range_of_product($product['product'][0]['id']);
                            echo $price['range'];
                ...
                <ul class="gap-2 list-unstyled m-0">
                    <?php if (!empty($product['product'][0]['warranty_period']) && isset($product['product'][0]['warranty_period'])) { ?>
                        <li>
                            ...
                            <p class="m-0"><?= $product_quantity['warranty_period'] ?></p>
                            <p class="m-0"><?= label('warranty', 'Warranty') ?></p>
                        </li>
                    <?php } else { ?>
                        <li>
                            <img src="<?= base_url("assets/front_end/modern/image/icons/no-warranty.png") ?>" alt="">
                            <p class="m-0"><?= label('no_warranty', 'No Warranty') ?></p>
                        </li>
                    <?php }
                    if (!empty($product['product'][0]['guarantee_period']) && isset($product['product'][0]['guarantee_period'])) { ?>
                        <li>
                            ...
                            <p class="m-0"><?= $product_quantity['guarantee_period'] ?></p>
                            <p class="m-0"><?= label('guarantee', 'Guarantee') ?></p>
                        </li>
                    <?php } ?>
                    <?php if (!empty($product['product'][0]['cod_allowed']) && isset($product['product'][0]['cod_allowed'])) { ?>
                        <li>
                            ...
                            <p class="m-0"><?= label('cod', 'COD') ?> <br> <?= label('avilable', 'Avilable') ?></p>
                        </li>
                    <?php } else { ?>
                        <li>
                            <img src="<?= base_url("assets/front_end/modern/image/icons/cod-not-avilable.png") ?>" alt="">
                            <p class="m-0"><?= label('cod', 'COD') ?> <br><?= label('not_Avilable', 'Not Avilable') ?></p>
                        </li>
                    <?php } ?>
                    <?php if (!empty($product['product'][0]['is_returnable']) && isset($product['product'][0]['is_returnable'])) { ?>
                        <li>
                            ...
                            <p><?= label('returnable', 'Returnable') ?></p>
                        </li>
                    <?php } else { ?>
                        <li>
                            <img src="<?= base_url("assets/front_end/modern/image/icons/non-returnable.png") ?>" alt="">
                            <p class="m-0"><?= label('non', 'Non') ?> <br> <?= label('returnable', 'Returnable') ?></p>
                        </li>
                    <?php } ?>
                    ...
                    <?php if (!empty($product['product'][0]['is_cancelable']) && isset($product['product'][0]['is_cancelable'])) { ?>
                        <li>
                            ...
                            <p><?= label('cancelable', 'cancelable') ?></p>
                        </li>
                    <?php } else { ?>
                        <li>
                            <img src="<?= base_url("assets/front_end/modern/image/icons/cancel.png") ?>" alt="">
                            <p><?= label('non', 'Non') ?> <br> <?= label('cancelable', 'cancelable') ?></p>
                        </li>
                    <?php } ?>
                </ul>
            </div>
            ...
            ?>
                <div class="item-detail pb-3 px-3">
    ...
    <section class="container">
        <div class="row customar-review py-4 border-bottom-0">
            <div class="customar-review-view col-md-6">
                <h4 class="element-title fw-semibold default-cursor m-0 pb-3"><?= label('customar_reviews', 'Customar Reviews') ?></h4>
                <?php
        ...
        ?>
            <div class="create-review-section col-md-6 <?= (!empty($my_rating)) ? 'd-none' : '' ?>" id="rating-box">
                ...
                <form action="<?= $form_link ?>" id="product-rating-form" method="POST">
                    ...
                    <div class="review-textarea py-2">
                        <h5 class="rating-title fw-semibold default-cursor mb-4"><?= label('compare', 'Compare') ?><?= label('add_photo_or_Video', 'Add Photo or Video') ?></h5>
                            ...
                            <a href="<?= base_url('products/details/' . $row['slug']) ?>" class="text-reset text-decoration-none">
                                <div class="card card-h-418 product-card" data-product-id="<?= $row['id'] ?>">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="btn add-in-cart-btn w-100 add_to_cart quickview-trigger" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-title="<?= $row['name'] ?>" data-product-image="<?= $row['image'] ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= $row['short_description']; ?>" data-bs-toggle="modal" data-bs-target="#quickview"><span class="add-in-cart">Add to
