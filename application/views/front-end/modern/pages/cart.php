        ...
        <div class="row py-4">
            <div class="col-xl-8">
                <div class="mb-4 cart-table">
                            ...
                            ?>
                                    <tr>
                                        <td class="product-removal">
                                            <ion-icon name="close-outline" class="remove-product" id="remove_inventory" data-id="<?= $row['id']; ?>" title="Remove From Cart"></ion-icon>
                                        </td>
                                        <td>
                    ...
                    <!-- <div class="coupon-box d-flex flex-wrap gap-3">
                    ...
                    <table class="table cart-total-table">
                        <tbody>
                            <tr class="cart-subtotal">
                                ...
                                <td>
                                    <p><?= $settings['currency'] . ' ' . number_format($cart['sub_total'], 2) ?></p>
                                </td>
                            </tr>
