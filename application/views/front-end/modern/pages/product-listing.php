    ...
    <section class="container-lg py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?= label('products', 'Products') ?></li>
            </ol>
        </nav>
        ...
        <div class="row m-0">
            <?php if (isset($products['filters']) && !empty($products['filters'])) { ?>
                <div class="col-lg-3 d-none d-lg-block filter-section p-3">
                    ...
                    <h5 class="m-0"><?= label('price', 'Price') ?></h5>
                    <button class="btn text-primary text-hover-effect p-0"><?= label('clear', 'Clear') ?></button>
                </div> -->
                    <!-- <div class="d-flex align-items-baseline gap-2 mb-3 mt-2">
                    ...
                    <select class="form-select" aria-label="Default select example">
                        ...
                        <option value="12000">₹25000</option>
                    </select>
                </div> -->
                    ...
                    <div class="text-center">
                        <button class="btn btn-primary product_filter_btn">Filter</button>
                    </div>
                </div>
            <?php } ?>
            ...
            <div class="col-lg-9">
                <?php if (isset($products) && !empty($products['product'])) { ?>
                    <div class="productlist-title-section d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-2">
                            <a href="<?= base_url('products') ?>" id="product_grid_view_btn" class="grid-list-icon-box link-dark">
                                <ion-icon class="grid-icons-outline" title="Grid view"></ion-icon>
                            </a>
                            <a href="<?= base_url('products/?type=list') ?>" id="product_grid_view_btn" class="grid-list-icon-box  link-dark">
                ...
                <?php if (isset($products) && !empty($products['product'])) { ?>
                                        ...
                                        <div class="row g-0">
                                            <div class="col-md-3">
                                                <div class="img-box-200">
                                                    ...
                                                    <img class="img-fluid rounded-start pic-1 lazy" src="<?= $row['image_sm'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="card-body">
                    ...
                    <?php } else { ?>
                        <div class="row my-4">
                            <?php
                            // $product_row = $row['product_details'];
                            // echo '<pre>';
                            // print_r($product_row);
                            // echo '</pre>';
                            // 
                            ...
                            ?>
                                <div class="col-md-4 col-sm-6 grid-card-container product-card">
                                        ...
                                        <a href="<?= base_url('products/details/' . $row['slug']) ?>" class="text-reset text-decoration-none">
                                            <div>
                                                <div class="img-box-h250">
                                                    <link itemprop="image" href="<?= $row['image_sm'] ?>" />
                                                    <img class="pic-1 lazy" src="<?= $row['image_sm'] ?>">
                                                </div>
                                            </div>
                                            <div class="card-body">
                                    ...
                                    10MP | 12MP Front Camera</p> -->
                                                ...
                                                ?>
                                                <a class="btn add-in-cart-btn w-100 add_to_cart quickview-trigger" href="" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-product-title="<?= $row['name'] ?>" data-product-image="<?= $row['image'] ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= $row['short_description']; ?>" data-bs-toggle="modal" data-bs-target="#quickview">
