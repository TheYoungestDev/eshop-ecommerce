                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group col-md-7 pl-0">
                                    ...
                                    <select id="modern_theme_color" name="modern_theme_color" class="form-control col-md-5">
                                        ...
                                        <option value="blue" <?= $web_settings['modern_theme_color'] == 'blue' ? 'selected' : '' ?>>blue</option>
                                        <option value="cyan-dark" <?= $web_settings['modern_theme_color'] == 'cyan-dark' ? 'selected' : '' ?>>Cyan dark</option>
                                        <option value="dark-blue" <?= $web_settings['modern_theme_color'] == 'dark-blue' ? 'selected' : '' ?>>Dark blue</option>
                                        <option value="dark-purple" <?= $web_settings['modern_theme_color'] == 'dark-purple' ? 'selected' : '' ?>>Dark purple</option>
                                        <option value="green" <?= $web_settings['modern_theme_color'] == 'green' ? 'selected' : '' ?>>Green</option>
                                        <option value="indigo" <?= $web_settings['modern_theme_color'] == 'indigo' ? 'selected' : '' ?>>Indigo</option>
                                        <option value="orange" <?= $web_settings['modern_theme_color'] == 'orange' ? 'selected' : '' ?>>Orange</option>
                                        <option value="peach" <?= $web_settings['modern_theme_color'] == 'peach' ? 'selected' : '' ?>>Peach</option>
                                        <option value="pink" <?= $web_settings['modern_theme_color'] == 'pink' ? 'selected' : '' ?>>Pink</option>
                                        <option value="purple" <?= $web_settings['modern_theme_color'] == 'purple' ? 'selected' : '' ?>>Purple</option>
                                        <option value="red" <?= $web_settings['modern_theme_color'] == 'red' ? 'selected' : '' ?>>Red</option>
                                    </select>
                                </div>
