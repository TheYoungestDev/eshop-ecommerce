                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-12 d-flex justify-content-between  mt-4">
                                                            <div class="col-md-4 is_cancelable  d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                ...
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate" href="javascript:void(0)"> <input type="checkbox" class="form-check-input " role="switch" name="is_cancelable" <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == '1') ? 'Checked' : '' ?> /></a>
