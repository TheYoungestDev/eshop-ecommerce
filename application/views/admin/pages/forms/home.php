        ...
        <div class="container-fluid p-3">
            <div class="row">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="card" style="background:#9271FE0d; border-radius:8px">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                <div class="align-self-center text-primary" style="background:#9271FE;border-radius:100%;width:80px;height:80px; display:flex;align-items:center;justify-content:center;font-size:46px;color:#fff !important">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="card" style="background:#ffb26e0d; border-radius:8px">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                <div class="align-self-center text-primary" style="background:#ffb26e;border-radius:100%;width:80px;height:80px; display:flex;align-items:center;justify-content:center;font-size:46px;color:#fff !important">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="card" style="background:#9DEFA30d; border-radius:8px">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify-content-md-between">
                                <div class="align-self-center text-primary" style="background:#9DEFA3;border-radius:100%;width:80px;height:80px; display:flex;align-items:center;justify-content:center;font-size:46px;color:#fff !important">
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 col-12">
                    ...
                    <div class="card" style="background:#6B9DFE0d; border-radius:8px">
                        <div class="card-body">
                            <div class="media d-flex align-items-center justify justify-content-md-between">
                                <div class="align-self-center text-info" style="background:#6B9DFE;border-radius:100%;width:80px;height:80px; display:flex;align-items:center;justify-content:center;font-size:46px;color:#fff !important">
